  ...
  return (
    <StyledLoginContainer>
      ...
      <StyledLoginTextInputContainer>
        ...
        />
        <StyledSubmitButton onPress={onSubmitPasswordEditing} buttonBackgroundColor={MAIN_COLOR}>
          <StyledSubmitButtonText buttonTextColor='white'>에브라티임 로그인</StyledSubmitButtonText>
        </StyledSubmitButton>
        <StyledSubmitButton>
